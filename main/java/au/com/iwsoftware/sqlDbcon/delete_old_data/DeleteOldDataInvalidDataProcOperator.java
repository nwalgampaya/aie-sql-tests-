...
public class DeleteOldDataInvalidDataProcOperator extends StoredProcedureOperator{

	public static final String PROCEDURE_NAME = "DeleteOldDataRollBack";
	public static final int PARAM_COUNT = 2;
	public static final String PARAM_STARTDATE = "deleteDate";
	public static final String PARAM_STATUS = "status";

	public DeleteOldDataInvalidDataProcOperator(String schemaName) {
